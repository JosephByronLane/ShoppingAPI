...
exports.seedPromotionalProducts = exports.seedProducts = void 0;
const Productos_1 = require("./models/Productos"); // adjust the import path according to your project structure
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            for (const data of productData) {
                const existingProduct = yield Productos_1.Productos.findOneBy({ nombre: data.nombre });
                if (!existingProduct) {
                    ...
                    producto.activo = (_a = data.activo) !== null && _a !== void 0 ? _a : 1;
...
function seedPromotionalProducts() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            for (const data of promoProducts) {
                const existingProduct = yield ProductosEnPromocion_1.ProductosEnPromocion.findOneBy({ nombre: data.nombre });
                if (!existingProduct) {
                    ...
                    promoProduct.producto = { id: data.producto_id };
...
exports.seedPromotionalProducts = seedPromotionalProducts;
;
